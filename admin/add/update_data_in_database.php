...
<body>
  ...
  $result = $conn->query("SELECT * FROM `cernum` WHERE no = '$no'");
  echo $result->num_rows;
  if($result->num_rows == 1) {



     $insert = mysqli_query($conn,"UPDATE `cernum` SET certificateNumber = '$certificateNumber'
